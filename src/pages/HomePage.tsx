...
const TIERS = [
  { name: 'Acolyte', price: '$5 / mo', color: 'tertiary', width: 'w-1/4', highlighted: false },
  { name: 'Mage', price: '$15 / mo', color: 'primary', width: 'w-1/2', highlighted: true },
  { name: 'Archmage', price: '$50 / mo', color: 'secondary', width: 'w-3/4', highlighted: false },
] as const;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-md mb-xl">
            {TIERS.map((tier) => (
              ...
              >
                ...
                <span className={`font-label-sm text-label-sm text-${tier.color} block mb-xs uppercase`}>
                  {tier.name}
                </span>
                ...
                <div className="mt-sm h-1 w-full bg-surface-container-highest rounded-full overflow-hidden">
                  <div
                    className={`h-full bg-${tier.color} ${tier.width} group-hover:w-full transition-all duration-500`}
                  />
                </div>
              </button>
            ))}
