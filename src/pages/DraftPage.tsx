...
import { StatsBar } from '../components/draft-board/StatsBar';
...
import { ExtraPickFab } from '../components/draft-board/ExtraPickFab';
 ...
 * each live in components/draft-board/ so they can be reused elsewhere.
 */
